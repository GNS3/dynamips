...
0x02: {
   ...
   : C0 46 XX XX (-) XX XX XX (-) XX(Part Number)
   : C1 8B XX XX XX XX XX XX XX XX XX XX XX(PCB Serial Number)
   : C2 8B XX XX XX XX XX XX XX XX XX XX XX(Chassis Serial Number)
