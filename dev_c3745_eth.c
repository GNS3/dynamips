 ...
 */
static int dev_c3745_nm_eth_init(c3745_t *router,char *name,u_int nm_bay,
                                 ...
                                 const struct cisco_eeprom *eeprom)
{
   ...
   /* Set the EEPROM */
   c3745_nm_set_eeprom(router,nm_bay,eeprom);
...
static int dev_c3745_nm_eth_shutdown(c3745_t *router,u_int nm_bay) 
{
...
static int dev_c3745_nm_eth_set_nio(c3745_t *router,u_int nm_bay,
...
static int dev_c3745_nm_eth_unset_nio(c3745_t *router,u_int nm_bay,
                                      u_int port_id)
{
   struct nm_eth_data *d;
 ...
 */
static int dev_c3745_nm_1fe_tx_init(c3745_t *router,char *name,u_int nm_bay)
{
   return(dev_c3745_nm_eth_init(router,name,nm_bay,1,AM79C971_TYPE_100BASE_TX,
...
/* Add a NM-16ESW */
static int dev_c3745_nm_16esw_init(c3745_t *router,char *name,u_int nm_bay)
{
   struct nm_16esw_data *data;

   /* Set the EEPROM */
   c3745_nm_set_eeprom(router,nm_bay,cisco_eeprom_find_nm("NM-16ESW"));
...
static int dev_c3745_nm_16esw_shutdown(c3745_t *router,u_int nm_bay) 
{
   struct c3745_nm_bay *bay;
   struct nm_16esw_data *data;
...
/* Bind a Network IO descriptor */
static int dev_c3745_nm_16esw_set_nio(c3745_t *router,u_int nm_bay,
                                      u_int port_id,netio_desc_t *nio)
{
...
/* Unbind a Network IO descriptor */
static int dev_c3745_nm_16esw_unset_nio(c3745_t *router,u_int nm_bay,
                                        u_int port_id)
{
   struct nm_16esw_data *d;
...
/* Show debug info */
static int dev_c3745_nm_16esw_show_info(c3745_t *router,u_int nm_bay)
{
   struct nm_16esw_data *d;
...
static int dev_c3745_gt96100_fe_init(c3745_t *router,char *name,u_int nm_bay)
{
   vm_obj_t *obj;
   ...
   /* Store device info into the router structure */
   return(c3745_nm_set_drvinfo(router,0,obj->data));
}

/* Nothing to do, we never remove the system controller */
static int dev_c3745_gt96100_fe_shutdown(c3745_t *router,u_int nm_bay) 
{   
   return(0);
}

/* Bind a Network IO descriptor */
static int dev_c3745_gt96100_fe_set_nio(c3745_t *router,u_int nm_bay,
                                        u_int port_id,netio_desc_t *nio)
{
   struct gt_data *d;
...
/* Unbind a Network IO descriptor */
static int dev_c3745_gt96100_fe_unset_nio(c3745_t *router,u_int nm_bay,
                                        u_int port_id)
{
   struct gt_data *d;
...
/* NM-1FE-TX driver */
struct c3745_nm_driver dev_c3745_nm_1fe_tx_driver = {
   "NM-1FE-TX", 1, 0,
   dev_c3745_nm_1fe_tx_init, 
...
/* NM-16ESW driver */
struct c3745_nm_driver dev_c3745_nm_16esw_driver = {
   "NM-16ESW", 1, 0,
...
struct c3745_nm_driver dev_c3745_gt96100_fe_driver = {
   "GT96100-FE", 1, 0,
